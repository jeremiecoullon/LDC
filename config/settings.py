"""
Django settings for LDC project on Heroku. For more info, see:
...
ALLOWED_HOSTS = ['.herokuapp.com', 'localhost', 'londondjangocollective.com', 'www.londondjangocollective.com']
...
# ===============
# Staticfiles on S3
if not os.path.isfile("../local.txt"):
    AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID')
    AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY')
    AWS_STORAGE_BUCKET_NAME = 'lwr-inverse-mcmc'
